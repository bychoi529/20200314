...
class ATM{
	...
	public void menu() {
		...
		boolean flag=true;
		while(flag) {
			System.out.println("은행을 선택하세요. 1.국민은행 2.농협 3.신한은행 4.종료" );
		    String inputStr=sc.nextLine();
		    switch(inputStr) {
		    case "1":
		    	System.out.println("국민은행 페이지로 이동합니다");
		    	new Bank("국민은행").menu();
		    	break;
		    	
		    case "2":
		    	System.out.println("농협 페이지로 이동합니다");
		    	new Bank("농협").menu();
		    	break;
		    case "3":
		    	System.out.println("신한은행 페이지로 이동합니다");
		    	new Bank("신한은행").menu();
		    	break;
		    case "4":
		    	System.out.println("종료합니다.");
